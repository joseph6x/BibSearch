if (Meteor.isClient) {
    ...
    this.App.resultCollectionRel = new Meteor.Collection(null);
    ...
    var Qmode = 0;
    var pa = -1;
    this.App.SearchRel = (function (uri) {
      //  var response = { 'content' : '{"head":{"vars":["Score1","Endpoint","EntityURI","EntityClass","EntityLabel","Property","PropertyLabel","PropertyValue","Year","Lang","Type","Score","Image","organization_des","nameCreator","issued","isbn","languaje"]},"results":{"bindings":[{"Score1":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#float","value":"8.723416"},"Endpoint":{"type":"literal","value":"UCUENCA"},"EntityURI":{"type":"uri","value":"http://sgb.ucuenca.edu.ec/buscador/rec/cdjbv/recurso/715a18e682ad49ec3a64075ba43dc36d"},"EntityClass":{"type":"uri","value":"http://purl.org/ontology/bibo/Document"},"EntityLabel":{"type":"literal","value":"Creo en Diego, futbolista todopoderoso"},"Property":{"type":"uri","value":"http://purl.org/dc/terms/subject"},"PropertyLabel":{"type":"literal","value":"Subject"},"PropertyValue":{"type":"literal","value":"MARADONA DIEGO"},"Lang":{"type":"literal","value":"Español"},"Type":{"type":"uri","value":"http://purl.org/ontology/bibo/Book"},"Score":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#integer","value":"1"},"organization_des":{"type":"literal","value":"CD-JBV"},"nameCreator":{"type":"literal","value":"Göltenboth, Natalie"},"languaje":{"type":"literal","value":"Español"}},{"Score1":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#float","value":"8.723416"},"Endpoint":{"type":"literal","value":"UCUENCA"},"EntityURI":{"type":"uri","value":"http://sgb.ucuenca.edu.ec/buscador/rec/cdjbv/recurso/107f1c640df5900594561b9428243a8d"},"EntityClass":{"type":"uri","value":"http://purl.org/ontology/bibo/Document"},"EntityLabel":{"type":"literal","value":"La marca de Dios"},"Property":{"type":"uri","value":"http://purl.org/dc/terms/subject"},"PropertyLabel":{"type":"literal","value":"Subject"},"PropertyValue":{"type":"literal","value":"MARADONA DIEGO"},"Lang":{"type":"literal","value":"Español"},"Type":{"type":"uri","value":"http://purl.org/ontology/bibo/Book"},"Score":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#integer","value":"1"},"organization_des":{"type":"literal","value":"CD-JBV"},"nameCreator":{"type":"literal","value":"Stok, Gustavo"},"languaje":{"type":"literal","value":"Español"}},{"Score1":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#float","value":"1.122104"},"Endpoint":{"type":"literal","value":"UCUENCA"},"EntityURI":{"type":"uri","value":"http://190.15.141.66:8899/ucuenca/recurso/14513"},"EntityClass":{"type":"uri","value":"http://purl.org/ontology/bibo/Document"},"EntityLabel":{"type":"literal","value":"Trayectoria periodística de Guifor Trujillo. Contenidos e influencia de su comentario en la sociedad cuencana"},"Property":{"type":"uri","value":"http://purl.org/ontology/bibo/abstract"},"PropertyLabel":{"type":"literal","value":"Abstract"},"PropertyValue":{"type":"literal","value":"Las cuatro décadas de ejercicio profesional no son un accidente para Guifor, narrador central de radio La Voz del Tomebamba, sino la cosecha de un esfuerzo diario. Él es uno de los eternos viajeros del Ecuador, pues ha transmitido varias mundiales de fútbol. Excelente comentarista de cabina y eso lo marca para las empresas que depositan en él la confianza,  verdadero triunfador escuchado en el estadio y en la calle. Es el único periodista ecuatoriano que narró en México 86 el gol denominado La mano de Dios de Maradona en el partido entre Argentina e Inglaterra.  Guifor Trujillo se confiesa hincha de todo lo que engloba el deporte cuencano, Identificado como defensor del pueblo, no escatima esfuerzo, cuando se trata de ayudar, lo hace sin interés. El nombre de Guifor Trujillo es sinónimo de credibilidad. No solo importa lo que se dice sino quien lo dice. Su estilo se ve reflejado en la búsqueda de la ecuanimidad, tranquilidad ante los sucesos, primero informa y luego orienta a la colectividad cuencana, es conocido y valorado, tiene el mejor conocimiento en deportes. Talvez pueda ser que en ocasiones hable de cosas triviales como de turismo o gastronomía, pero a quién le importa si ese es su estilo y la gente lo adorará aún más. Tiene la idea de cómo hacer periodismo deportivo, La audiencia se va dando cuenta de quién en realidad tiene mejor conocimiento o más agallas para hacerlo, no solo informa, sino que pone humor a sus comentarios."},"Year":{"type":"literal","value":"2008"},"Lang":{"type":"literal","value":"Español"},"Type":{"type":"uri","value":"http://purl.org/ontology/bibo/Thesis"},"Score":{"type":"literal","datatype":"http://www.w3.org/2001/XMLSchema#integer","value":"1"},"organization_des":{"type":"literal","value":"DSPACE-UC"},"nameCreator":{"type":"literal","value":"Matovelle Solano, Paúl Andrés"},"issued":{"type":"literal","value":"2008"},"languaje":{"type":"literal","value":"Español"}}]}}'};
            Qmode = 1;
              console.log ("Realizar petición a server"); 
              console.log (uri);
                 waitingDialog.show();
             Meteor.call('queryRecomendedItems', uri, function (error, result) {
                 console.log ("Respuesta de server");
                console.log (result);
                 if (result.statusCode == 200) {
               App.resultCollectionRel.remove({});
               App.resultCollectionRel.insert(result);
                }
             });
              //   waitingDialog.hide();
          return "";
                        ...
                        [
                            {key: 'urifav',
                                ...
                                fn: function (urifav, object) {
                                  console.log(object);
                                    var html = '<a target="_blank" href="' + urifav + '">Recurso </a>';
                                    return new Spacebars.SafeString(html);
                                }
    ...
    Template.search.helpers({
        facetedOptions: function () {
            ...
            if (nn != undefined && nn != null) {
                ...
                n.Sources = n.Sources.map(function (d) {
                    var r = nn.Sources.filter(function (q) {
                        return q.key == d.key;
                    });
                    if (r.length > 0) {
                        d.count = r[0].count;
            ...
            var facetes = [{Title: lang.lang('lblYears'), Range: true, Values: n.Years, Values2: JSON.stringify(n.Years), Exists: n.Years2.length > 0, Min: n.Years2.length > 0 ? n.Years2[0].key : 0, Max: n.Years2.length > 0 ? n.Years2[n.Years2.length - 1].key : 0},
                ...
                {Title: lang.lang('lblSources'), Range: false, Exists: n.Sources.length > 0, Values: n.Sources},
        ...
        RelatedItems : function (Uri) {
            var response = App.resultCollectionRel.findOne();
            console.log ("Respuesta");
            console.log (response);
            var r =  dataSourceSearch(response);
            waitingDialog.hide();
             $("#myrelatedmodal").modal();
             $("#myrelatedmodal").attr("URI", Uri);
            return r;
        ...
        if (response) {
            ...
            for (var k = 0; k < resp.length; k++) {
                ...
                if (OneResult.length == 0) {
                    ...
                    //Name of author
                    try {
                      OneResult.nameCreator = resp[k].nameCreator.value.replace(',','');
                    ...
                    //ISBN
                    try {
                      OneResult.isbn = resp[k].isbn.value;
                    ...
                    //YEAR
                    try {
                      OneResult.issued = resp[k].issued.value;
                    ...
                    //Languaje
                    try {
                      OneResult.languaje = resp[k].languaje.value;
...
//toShow.sort(compare);
    ...
    function language() {
        ...
        var idiomEng = {
            ...
            "FoS_17": "Psychology",
            "FoS_18": "Sociology",
            "welcome-title": "Semantic Search Engine for Bibliographic Resources",//"Portal of bibliographic data of the University of Cuenca",
            "resources-search": "Search by: Thesis, scientific articles, books, etc.",
        ...
        var idiomEsp = {
            ...
            "FoS_17": "Psicología",
            "FoS_18": "Sociología",
            "welcome-title": "Buscador Semántico de Recursos Bibliográficos",//"Portal de datos bibliográficos de la Universidad de Cuenca",
            "resources-search": "Buscando por: Tesis, Articulos, Libros, etc.",
            ...
            "sug": "Sugerencias",
            "alt-query" : "Busqueda Alternativa",
            "fac": "Filtros",
            "noData": "No hay datos",
